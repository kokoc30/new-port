    ...
    if (contactForm) {
        contactForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                console.log('Form submission simulated - please configure Formspree endpoint');
...
function revealCards() {
    const cards = document.querySelectorAll('.project-card, .education-card, .extra-item');
...
// Initialize card reveal on scroll
